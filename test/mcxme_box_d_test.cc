...
TEST(PhTreeBoxDTest, TestInsert) {
    const dimension_t dim = 3;
    ...
    for (size_t i = 0; i < N; i++) {
        ...
        ASSERT_TRUE(tree.find(p).first);
        ASSERT_EQ(id._i, tree.find(p).second);
    ...
    for (size_t i = 0; i < N; i++) {
        PhBoxD<dim>& p = points.at(i);
        ASSERT_EQ(tree.count(p), 1);
        ASSERT_EQ(i, tree.find(p).second);
    }
}

//TEST(PhTreeBoxDTest, TestEmplace) {
//    const dimension_t dim = 3;
//    TestTree<dim, Id> tree;
//    size_t N = 1000;
//
...
//}
//
//TEST(PhTreeBoxDTest, TestSquareBrackets) {
//    const dimension_t dim = 3;
//    TestTree<dim, Id> tree;
//    size_t N = 1000;
//
...
//template <dimension_t DIM>
//void populate(
//    PhTreeBoxD<DIM, size_t>& tree, std::vector<PhBoxD<DIM>>& points, size_t N, double boxLen = 10) {
...
//}
//
//TEST(PhTreeBoxDTest, TestRangeBasedForLoop) {
//    const dimension_t dim = 3;
//    TestTree<dim, Id> tree;
//    size_t N = 10000;
//    std::vector<PhBoxD<dim>> points;
...
//}
//
//TEST(PhTreeBoxDTest, TestWindowQueryAll) {
//    const dimension_t dim = 3;
...
//}
//
//TEST(PhTreeBoxDTest, TestWindowQueryManyMovingPoint) {
//    size_t N = 10000;
//    const dimension_t dim = 3;
//    TestTree<dim, Id> tree;
//    std::vector<PhBoxD<dim>> points;
...
//}
//
//TEST(PhTreeBoxDTest, SmokeTestPointAPI) {
//    PhBoxD<3> p({1, 2, 3}, {4, 5, 6});
//    (void)p;
//}
//
//TEST(PhTreeBoxDTest, SmokeTestTreeAPI) {
//    std::map<int, Id*> mapPtr;
//    PhTreeBoxD<3, Id*> treePtr;
//    Id* idPtr = new Id(1);
